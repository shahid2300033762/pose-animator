"""
Live camera feed + pose animation side by side - no hanging.
"""
...
class LiveAndPoseAnimator:
    ...
    def _create_gui(self):
        ...
        self.live_label = ttk.Label(self.live_frame, text="Live feed will appear here", 
    ...
    def _update_loop(self):
        ...
        # Schedule next update - reduced frequency to prevent hanging
        self.root.after(50, self._update_loop)  # ~20 FPS instead of 30
...
if __name__ == "__main__":
    print("Starting Live Feed + Pose Animation...")
    app = LiveAndPoseAnimator()
    app.run()
